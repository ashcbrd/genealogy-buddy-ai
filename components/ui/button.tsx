  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover-lift shadow-sm hover:shadow-md",
        ...
        success: "bg-green-600 text-white hover:bg-green-700 hover-lift shadow-sm hover:shadow-md",
        warning: "bg-yellow-600 text-white hover:bg-yellow-700 hover-lift shadow-sm hover:shadow-md",
        info: "bg-blue-600 text-white hover:bg-blue-700 hover-lift shadow-sm hover:shadow-md",
      },
      size: {
